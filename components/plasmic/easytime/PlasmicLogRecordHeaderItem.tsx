    ...
    () => [
      {
        ...
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.order
          : undefined,
      },
    ],
    [$props, $ctx]
    ...
    >
      {p.renderPlasmicSlot({
        ...
        className: classNames(sty.slotTargetLabel, {
          [sty.slotTargetLabelorder_asc]: hasVariant($state, "order", "asc"),
          [sty.slotTargetLabelorder_desc]: hasVariant($state, "order", "desc"),
        }),
      })}
      {(
        hasVariant($state, "order", "desc")
          ? true
          : hasVariant($state, "order", "asc")
          ? true
          : true
      ) ? (
        <div
