    ...
    () => [
      {
        ...
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.deleted
          : undefined,
      },
      {
        path: "isIndividual.isChecked",
        type: "private",
        ...
        >
          ...
          <Container
            ...
            className={classNames("__wab_instance", sty.container, {
              [sty.containerdeleted]: hasVariant($state, "deleted", "deleted"),
            })}
          >
            <div className={classNames(projectcss.all, sty.freeBox___8Tq8B)}>
              ...
              >
                {(hasVariant($state, "deleted", "deleted") ? true : true) ? (
                  <Button
                ...
                {(hasVariant($state, "deleted", "deleted") ? true : false) ? (
                  <Button
