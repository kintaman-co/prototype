    ...
    () => [
      {
        ...
        initFunc: true
          ? ({ $props, $state, $queries, $ctx }) => $props.dayAgo
          : undefined,
      },
    ],
    [$props, $ctx]
    ...
    >
      ...
      <p.Stack
        ...
        className={classNames(projectcss.all, sty.dayAgoCheckbox, {
          [sty.dayAgoCheckboxdayAgo]: hasVariant($state, "dayAgo", "dayAgo"),
        })}
      >
        <Checkbox
          ...
          className={classNames("__wab_instance", sty.checkbox, {
            [sty.checkboxdayAgo]: hasVariant($state, "dayAgo", "dayAgo"),
          })}
          selected={hasVariant($state, "dayAgo", "dayAgo") ? true : undefined}
        />
